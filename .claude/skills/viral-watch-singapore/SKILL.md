...
description: Variant of /viral-watch locked to Singapore only. Top 10 viral Singapore news of the window in a single LinkedIn post, CTO voice (Business Strategy + HR + IT remit), with per-story LinkedIn-worthiness gate + post-level review. **Political content is EXCLUDED by default** (inherited from parent /viral-watch Step 3.5 filter: no elections, party politics, partisan corruption, partisan-flashpoint legislation, civil-rights enforcement tied to political ideology, royal-house political messaging). Use `politics: include` to opt in. Use when the user says "viral watch Singapore", "top 10 viral SG", "viral Singapore news", or invokes /viral-watch-singapore.
---
